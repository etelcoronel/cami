...
class Cami extends CI_Controller
{
    ...
    function sendMail($registro) {
        ...
        $mail->Username = "cami.mx.page@gmail.com";
        //Password to use for SMTP authentication
        $mail->Password = "V1ct0rfu3nt3s@";
        //Set who the message is to be sent from
        $mail->setFrom("cami.mx.page@gmail.com", 'http://cami.mx/');
        //Set an alternative reply-to address
       // $mail->addReplyTo('sacorus@gmail.com', 'http://cami.mx/');
        //Set who the message is to be sent to
        $mail->addAddress($registro['email'], 'Solicitante');
        $mail->addCC('cami.mx.page@gmail.com');
        $mail->addCC('cami.networks@gmail.com');
        //Set the subject line
        $mail->Subject = 'Informacion sobre planes de redes.';
